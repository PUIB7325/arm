...
# Initialiser l'historique des questions et réponses
...
if st.button("Générer une réponse avec RAG"):
    if prompt_rag:
        ...
        st.session_state.history.append({"question": prompt_rag, "response": response})
...
if st.button("Générer une réponse sans RAG"):
    if prompt_no_rag:
        ...
        # Ajouter à l'historique
        st.session_state.history.append({"question": prompt_no_rag, "response": response})
    else:
        st.warning("Veuillez entrer une question.")

# Afficher l'historique dans la barre latérale
st.sidebar.header("Historique des questions et réponses")
for entry in st.session_state.history:
    st.sidebar.subheader("Question:")
    st.sidebar.write(entry["question"])
    st.sidebar.subheader("Réponse:")
    st.sidebar.write(entry["response"])
